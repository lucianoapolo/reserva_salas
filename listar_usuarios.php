...
<form name="form1" id="form1" method="post">
	<div align="center">
		<table class="text_normal" cellpadding="2" cellspacing="2" border="0">
			<tr>
				<td align="center" class="table_titulo" colspan="4">&nbsp;Listar Usuários&nbsp;</td>
			</tr>
			<tr>
				<td align="center" class="table_titulo">&nbsp;Nome&nbsp;</td>
				<td align="center" class="table_titulo">&nbsp;Login&nbsp;</td>
			...
			$arr_results = $table_usuarios->getAll(false, false, array('id'));
			...
			if (count($arr_results) > 0) {
				...
				<tr>
					...
					<td align="center"><?php print $arr_result['login']; ?></td>
					<td align="center"><?php if ($arr_result['ativo'] == '1') { print '<font color=blue>ATIVO</font>'; } else { print '<font color=red>INATIVO</font>'; } ?></td>
					<td align="center"><a href="usuario.php?id=<?php print $arr_result['id']; ?>" class="link_lista">EDITAR</a></td>
				</tr>
				<?php
